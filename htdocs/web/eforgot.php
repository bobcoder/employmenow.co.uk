...
if (isset($_POST['submit'])) {
    ...
    $result = mysql_query("SELECT `id`,`name`,`active`,`password` FROM `employers` WHERE `email`='$email'");
    if (!$result)
            ...
            <div id="page" class="container">
                <div id="content">
                    <div class="generalleft faded">
                        <h1 class="homeh1">Forgotten password</h1>
                        <br/>
                        <?php
echo $error;
if(!isset($_POST['submit'])) {
                        ...
                        <form name="frmLogin" method="post">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <input type="submit" class="searchbutton" name="submit" value="Send">
                                    </td>
                                </tr>
                            </table>
