				...
				<form id="jobs" name="jobs" method="post" class="cmxform">
				    <div id='new_jobs'>
				        ...
				        <label> <span>Job reference <span class="req">*</span></span>
				            <BR>
				            <input maxlength="255" size="30" id="ref" name="ref" type="text" title="Your own ref number for this vacancy.">
				        </label>
				        <br>
				        ...
				        <label><span>Description <span class="req">*</span></span></label>
				            <br><textarea class="tinymce" name="description" id="description"></textarea>
				        <br>
				        ...
				        <label> <span>Active</span> <span style="color:red;">(To close your vacancy now please un-tick)</span>
				            <br>
				        ...
				        <input form="jobs" value="Update Job" id="newjob" class="searchbutton" name="submit" type="submit">
				        <br>
				    </div>
				</form>
			</div>
		    ...
		    $( "#dialog-modal" ).dialog({
		      ...
		      buttons: {
		        "Update Job": function() {
			            ...
			            $.ajax({
			                url : 'office/job_update_db.php?action=updatejob',
			                type : 'post',
			                dataType : 'text',
...
<div id="dialog-modal" title="Edited Job" style="display: none;">
  <p>Thank you for editing your vacancy, it has been submitted for review, and is pending approval. Your vacancy will be live within 24 hours.</p>
</div>
</body>
</html>